...
UBUNTU_TRANSLATION_DOMAIN="netspeed.turan-mahmudov-l"
...
aptest.commands = bash $$PWD/NetSpeed/tests/autopilot/run
aptest.depends  = sub-NetSpeed

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/NetSpeed/tests/unit 
unittest.depends  = sub-NetSpeed
